...
import { studentsAPI, subjectsAPI, resultsAPI, usersAPI } from '../../services/api';
  ...
  return (
    <div>
      ...
      <div style={styles.quickActions}>
        ...
        <p style={styles.info}>
          Use the navigation menu to manage users, students, subjects, classes, and view results.
        </p>
      </div>
    </div>
  );
